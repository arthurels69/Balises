...
final class Version20190605082257 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user
            ADD CONSTRAINT FK_8D93D6495CB2E05D
            FOREIGN KEY (login_id) REFERENCES theater (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD login VARCHAR(255) NOT NULL
            COLLATE utf8mb4_unicode_ci, ADD password VARCHAR(255) NOT NULL
            COLLATE utf8mb4_unicode_ci, ADD role SMALLINT NOT NULL, DROP login_id');
    }
}
