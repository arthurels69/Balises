...
final class Version20190606185149 extends AbstractMigration
{
 ...
 theater_id_id INT NOT NULL, title VARCHAR(255) NOT NULL,
  description LONGTEXT NOT NULL, distribution LONGTEXT NOT NULL,
   mandatory_infos LONGTEXT DEFAULT NULL, image VARCHAR(255) NOT NULL,
    photo_credits VARCHAR(255) DEFAULT NULL, additional_infos LONGTEXT DEFAULT NULL,
     is_balise TINYINT(1) NOT NULL, offer_type SMALLINT DEFAULT NULL, mapado_link VARCHAR(255) DEFAULT NULL,
      base_rate DOUBLE PRECISION DEFAULT NULL, INDEX IDX_E55076F44ECC313E (theater_id_id),
 ...
 email VARCHAR(180) NOT NULL, theater_name VARCHAR(180) DEFAULT NULL,
 ...
 show_date_id INT NOT NULL, free_places_number INT DEFAULT NULL, discounted_rate INT DEFAULT NULL,
 ...
 user_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL,
  address1 VARCHAR(255) DEFAULT NULL, address2 VARCHAR(255) DEFAULT NULL, zip_code INT DEFAULT NULL,
   city VARCHAR(255) DEFAULT NULL, phone_number VARCHAR(255) DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL,
    website VARCHAR(255) DEFAULT NULL, base_rate DOUBLE PRECISION DEFAULT NULL, lat DOUBLE PRECISION DEFAULT NULL,
 ...
 show_id_id INT DEFAULT NULL, date_show DATETIME NOT NULL,
