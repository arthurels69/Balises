...
final class Version20190606185149 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE spectacle (id INT AUTO_INCREMENT 
NOT NULL, theater_id_id INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT 
NOT NULL, distribution LONGTEXT NOT NULL, mandatory_infos LONGTEXT DEFAULT NULL, image VARCHAR(255) 
NOT NULL, photo_credits 
VARCHAR(255) DEFAULT NULL, additional_infos LONGTEXT 
DEFAULT NULL, is_balise TINYINT(1) NOT NULL, offer_type SMALLINT DEFAULT 
NULL, mapado_link VARCHAR(255) DEFAULT NULL, base_rate 
DOUBLE PRECISION DEFAULT NULL, INDEX IDX_E55076F44ECC313E (theater_id_id), 
...
SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT 
NOT NULL, email VARCHAR(180) NOT NULL, theater_name VARCHAR(180) DEFAULT 
NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, 
UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT 
CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE show_rate (id INT AUTO_INCREMENT 
NOT NULL, show_date_id INT NOT NULL, free_places_number INT DEFAULT 
NULL, discounted_rate INT DEFAULT NULL, UNIQUE INDEX UNIQ_31BE9FADFC51B88 (show_date_id), 
PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 
COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
...
DEFAULT NULL, phone_number VARCHAR(255) DEFAULT NULL, logo VARCHAR(255) 
DEFAULT NULL, website VARCHAR(255) DEFAULT NULL, base_rate DOUBLE 
PRECISION DEFAULT NULL, lat DOUBLE PRECISION 
DEFAULT NULL, longitude DOUBLE PRECISION DEFAULT NULL, UNIQUE INDEX UNIQ_46DD8154A76ED395 (user_id), 
PRIMARY KEY(id)) DEFAULT 
CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE show_date (id INT AUTO_INCREMENT 
NOT NULL, show_id_id INT DEFAULT NULL, date_show DATETIME NOT NULL, INDEX IDX_7669E1B97DF5FA8B (show_id_id), 
PRIMARY KEY(id)) DEFAULT 
CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
